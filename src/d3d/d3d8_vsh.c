...
/* Word 0 fields */
#define VSH_FIELD_ILU_OP_START      32+25
#define VSH_FIELD_ILU_OP_SIZE       3
#define VSH_FIELD_MAC_OP_START      32+21
#define VSH_FIELD_MAC_OP_SIZE       4
#define VSH_FIELD_CONST_IDX_START   32+13
#define VSH_FIELD_CONST_IDX_SIZE    8
#define VSH_FIELD_INPUT_IDX_START   32+9
...
#define VSH_FIELD_ILU_DST_MASK_START   96+16
#define VSH_FIELD_ILU_DST_MASK_SIZE    4
#define VSH_FIELD_ILU_DST_OUT_START    96+3
