...
parallel 2, this branch, 2026-08-25): Release `--clean-first`: 3.26 s;
unchanged Release rebuild: 0.54 s. These are library timings, not a
generated MM3 function rebuild.
